...
export default function Loader({ children }: LoaderProps) {
  ...
  useEffect(() => {
    ...
    const animateSvg = () => {
      if (svgRef.current) {
        gsap.to(svgRef.current.querySelectorAll("g > g > path, g > g > polyline"), {
          strokeDashoffset: 0,
          duration: 1.8,
          ease: "power2.out",
          stagger: 0.15
    ...
    // Start SVG animation after a shorter delay for smoother start
    const svgTimer = setTimeout(() => {
      animateSvg()
    }, 200)

    // Complete loading after SVG animation with additional pause
  ...
  return (
    <>
                ...
                >
                  ...
                  <g id="l">
                    <g clipPath="url(#clip-path-2)">
                      <polyline id="l_path" points="820.4 302.62 755.9 334.12 843.9 39.12 784.4 63.62"
                        fill="none" stroke="#84cc16" strokeMiterlimit="10" strokeWidth="42"></polyline>
                    </g>
                  </g>
                  <g id="i">
                    <g clipPath="url(#clip-path-3)">
                      <polyline id="i_path" points="207.9 165.12 254.9 147.12 201.9 329.12 262.9 299.12"
                        fill="none" stroke="#84cc16" strokeMiterlimit="10" strokeWidth="42"></polyline>
                    </g>
                  </g>
                  <g id="a">
                    <g clipPath="url(#clip-path-4)">
                      <path id="a_path"
                        ...
                        transform="translate(31.09 32.56)" fill="none" stroke="#84cc16"
                        strokeMiterlimit="10" strokeWidth="42"></path>
                    </g>
                  </g>
                  <g id="u">
                    <g clipPath="url(#clip-path-5)">
                      <path id="u_path" d="M371.81,132.56l64-31-68,200,34-7s80-120,109-181l15-4-55,187,60-33"
                        transform="translate(31.09 32.56)" fill="none" stroke="#84cc16"
                        strokeMiterlimit="10" strokeWidth="42"></path>
                    </g>
                  </g>
                  ...
                  <g id="V">
                    <g clipPath="url(#clip-path-7)">
                      <path id="v_path"
                        ...
                        transform="translate(31.09 32.56)" fill="none" stroke="#84cc16"
                        strokeMiterlimit="10" strokeWidth="70"></path>
                    </g>
                  </g>
                </svg>
              </div>
      ...
      {/* Theme Toggle Button - only visible when not loading and on desktop */}
      <AnimatePresence>
        {!loading && (
          <motion.div
            ...
            className="hidden lg:block absolute top-11 right-16 z-40"
          >
            <ThemeToggleButton />
          </motion.div>
        )}
