            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            ...
                            <Avatar className="-ml-6 border-transparent">
                                <div className="size-full bg-muted rounded-full inline-flex items-center justify-center gap-1">
                    ...
                    <FeatureCard
                        ...
                        className="md:col-span-2 lg:col-span-1"
                    >
                        <div className="aspect-video flex itens justify-center">
                            <p className="text-4xl font-extrabold text-muted-foreground text-center">
                                We've achieved{" "}
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        <div
                            key={feature}
                            className="bg-muted border border-border inline-flex px-3 py-1.5 md:px-5 md:py-2 rounded-2xl gap-3 items-center"
                        >
